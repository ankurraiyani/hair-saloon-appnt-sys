...
export class UpdateServiceComponent implements OnInit {
    ...
    constructor(private getshop:GetshopService, private update:UpdateServiceService, private router:Router, private getService:GetServiceInfoService, private removeService:DeleteServiceService){}
  ngOnInit(): void {
    this.getService.fetchServicebyId(localStorage.getItem('serviceId')).subscribe((data:any)=>{
    ...
    confirmDeleteService() {
      this.removeService.deleteService(localStorage.getItem('serviceId')).subscribe((data: any) => {
